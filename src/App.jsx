...
export default function App() {
  ...
  const timer = useRef();
  const { database, execution, error, executeQuery, executeScript, executeSandboxSql, deleteTable, restoreSeedDatabase, clearExecution, clearError, showError } = useSqlRuntime();
  ...
  const restoreSandboxDatabase = () => { clearInterval(timer.current); restoreSeedDatabase(); clearImportMessage(); setActiveStep(0); setShowAll(true); setStepMode(false); };
