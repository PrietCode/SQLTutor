...
export function SubqueryDependencyNote({ step }) {
  ...
  return (
    <div className="subquery-parent-note">
      <strong>Condición con subconsulta</strong>
      <code>{parentConditionText(step)}</code>
      <p>
        La condición utiliza una subconsulta. En el siguiente paso se muestra cómo se obtiene su
        resultado.
      </p>
    </div>
  );
